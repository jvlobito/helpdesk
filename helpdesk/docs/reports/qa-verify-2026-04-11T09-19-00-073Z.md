...
- Fecha: 2026-04-11T09:19:00.073Z
- Entorno: Local
- Version o referencia del build: QA_APP_URL=http://127.0.0.1:3054
...
| QA-AUTO-05 | Cliente | OK | Ticket TKT-100600 creado y visible en cliente/agente. |  | Validacion automatizada exitosa |
...
| QA-AUTO-07 | Supervisor | OK | Departamento QA Dept 1775899109863 creado, editado y visible en supervisor. |  | Validacion automatizada exitosa |
...
| QA-AUTO-13 | Agente | OK | El ticket TKT-100601 exige nota de resolucion y persiste resolution_note al resolver. |  | Validacion automatizada exitosa |
| QA-AUTO-14 | Agente | OK | El ticket TKT-100602 bloquea cierre y reapertura manual desde la vista operativa interna. |  | Validacion automatizada exitosa |
...
| QA-AUTO-16 | Cliente | OK | El cliente ve cierre en TKT-100605 y reapertura en TKT-100606. |  | Validacion automatizada exitosa |
| QA-AUTO-16A | Supervisor | OK | El supervisor ve cierre en TKT-100607 y reapertura en TKT-100608. |  | Validacion automatizada exitosa |
| QA-AUTO-16B | Agente | OK | El agente ve cierre en TKT-100609 y reapertura en TKT-100610. |  | Validacion automatizada exitosa |
| QA-AUTO-17 | Cliente | OK | El ticket TKT-100611 persiste adjunto y lo muestra en detalle para cliente y agente. |  | Validacion automatizada exitosa |
| QA-AUTO-18 | Cliente | OK | El comentario publico sobre TKT-100612 persiste adjunto y es visible para agente y cliente. |  | Validacion automatizada exitosa |
| QA-AUTO-19 | Cliente | OK | La app bloquea adjuntos mayores a 5 MB con error controlado. |  | Validacion automatizada exitosa |
| QA-AUTO-20 | Cliente | OK | El cliente recibe notificaciones internas por comentario publico y resolucion sobre TKT-100613. |  | Validacion automatizada exitosa |
| QA-AUTO-21 | Agente | OK | El agente destino recibe notificacion interna al reasignar TKT-100614. |  | Validacion automatizada exitosa |
...
| QA-AUTO-23 | Agente | OK | El ticket TKT-100615 se comporta como estado final cerrado en cliente, agente y supervisor. |  | Validacion automatizada exitosa |
| QA-AUTO-24 | Sistema | OK | El ticket TKT-100616 se autocerro por vencimiento con motivo sin_respuesta_cliente y notificaciones emitidas. |  | Validacion automatizada exitosa |
| QA-AUTO-33 | Sistema | OK | El autocierre registro corrida success (48jxhju3opkmd8j) y libero el lock correctamente. |  | Validacion automatizada exitosa |
| QA-AUTO-34 | Sistema | FALLO | La corrida con lock activo devolvio error inesperado: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | La corrida con lock activo devolvio error inesperado: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | Revisar evidencia e incidencia |
| QA-AUTO-35 | Sistema | FALLO | El dry-run de autocierre fallo: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | El dry-run de autocierre fallo: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | Revisar evidencia e incidencia |
...
| QA-AUTO-08 | Agente | OK | Cliente confirmo cierre de TKT-100619 con closed_at persistido. |  | Validacion automatizada exitosa |
| QA-AUTO-09 | Supervisor | OK | Cliente solicito reapertura de TKT-100620 con motivo persistido. |  | Validacion automatizada exitosa |

## Incidencias abiertas

| ID incidencia | Severidad | Caso asociado | Descripcion | Estado |
| --- | --- | --- | --- | --- |
| INC-AUTO-001 | Alta | QA-AUTO-34 | La corrida con lock activo devolvio error inesperado: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | Abierta |
| INC-AUTO-002 | Alta | QA-AUTO-35 | El dry-run de autocierre fallo: Assertion failed: !(handle->flags & UV_HANDLE_CLOSING), file src\win\async.c, line 76
 | Abierta |
...
- Fecha de cierre: 2026-04-11T09:19:00.073Z
