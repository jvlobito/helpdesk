...
- Fecha: 2026-04-14T18:51:48.492Z
- Entorno: Local
- Version o referencia del build: QA_APP_URL=http://127.0.0.1:3065
...
- Estado final: OK
- Resumen ejecutivo: 49 casos OK, 0 casos con fallo.
...
| QA-AUTO-05 | Cliente | OK | Ticket TKT-100847 creado y visible en cliente/agente. |  | Validacion automatizada exitosa |
...
| QA-AUTO-07 | Supervisor | OK | Departamento QA Dept 1776192676987 creado, editado y visible en supervisor. |  | Validacion automatizada exitosa |
...
| QA-AUTO-13 | Agente | OK | El ticket TKT-100848 exige nota de resolucion y persiste resolution_note al resolver. |  | Validacion automatizada exitosa |
| QA-AUTO-14 | Agente | OK | El ticket TKT-100849 bloquea cierre y reapertura manual desde la vista operativa interna. |  | Validacion automatizada exitosa |
...
| QA-AUTO-16 | Cliente | OK | El cliente ve cierre en TKT-100852 y reapertura en TKT-100853. |  | Validacion automatizada exitosa |
| QA-AUTO-16A | Supervisor | OK | El supervisor ve cierre en TKT-100854 y reapertura en TKT-100855. |  | Validacion automatizada exitosa |
| QA-AUTO-16B | Agente | OK | El agente ve cierre en TKT-100856 y reapertura en TKT-100857. |  | Validacion automatizada exitosa |
| QA-AUTO-17 | Cliente | OK | El ticket TKT-100858 persiste adjunto y lo muestra en detalle para cliente y agente. |  | Validacion automatizada exitosa |
| QA-AUTO-18 | Cliente | OK | El comentario publico sobre TKT-100859 persiste adjunto y es visible para agente y cliente. |  | Validacion automatizada exitosa |
| QA-AUTO-19 | Cliente | OK | La app bloquea adjuntos mayores a 5 MB con error controlado. |  | Validacion automatizada exitosa |
| QA-AUTO-20 | Cliente | OK | El cliente recibe notificaciones internas por comentario publico y resolucion sobre TKT-100860. |  | Validacion automatizada exitosa |
| QA-AUTO-21 | Agente | OK | El agente destino recibe notificacion interna al reasignar TKT-100861. |  | Validacion automatizada exitosa |
...
| QA-AUTO-23 | Agente | OK | El ticket TKT-100862 se comporta como estado final cerrado en cliente, agente y supervisor. |  | Validacion automatizada exitosa |
| QA-AUTO-24 | Sistema | OK | El ticket TKT-100863 se autocerro por vencimiento con motivo sin_respuesta_cliente y notificaciones emitidas. |  | Validacion automatizada exitosa |
| QA-AUTO-33 | Sistema | OK | El autocierre registro corrida success (zbfxxb0fr4zuqjm) y libero el lock correctamente. |  | Validacion automatizada exitosa |
| QA-AUTO-34 | Sistema | OK | La segunda corrida quedo en skipped (eucwf55qf3zn8zt) al detectar lock activo. |  | Validacion automatizada exitosa |
| QA-AUTO-35 | Sistema | OK | El dry-run registro corrida 6pvscbuzf9dv0f4 sin modificar el ticket TKT-100865. |  | Validacion automatizada exitosa |
| QA-AUTO-36 | Sistema | OK | La corrida 1h8jlu0f25jjz27 quedo en partial_failure, mantuvo TKT-100866 en resolved y cerro TKT-100867. |  | Validacion automatizada exitosa |
...
| QA-AUTO-08 | Agente | OK | Cliente confirmo cierre de TKT-100868 con closed_at persistido. |  | Validacion automatizada exitosa |
| QA-AUTO-09 | Supervisor | OK | Cliente solicito reapertura de TKT-100869 con motivo persistido. |  | Validacion automatizada exitosa |
...
- Fecha de cierre: 2026-04-14T18:51:48.492Z
