...
- Fecha: 2026-04-11T10:15:04.780Z
- Entorno: Local
- Version o referencia del build: QA_APP_URL=http://127.0.0.1:3062
...
| QA-AUTO-05 | Cliente | OK | Ticket TKT-100778 creado y visible en cliente/agente. |  | Validacion automatizada exitosa |
...
| QA-AUTO-07 | Supervisor | OK | Departamento QA Dept 1775902475176 creado, editado y visible en supervisor. |  | Validacion automatizada exitosa |
...
| QA-AUTO-13 | Agente | OK | El ticket TKT-100779 exige nota de resolucion y persiste resolution_note al resolver. |  | Validacion automatizada exitosa |
| QA-AUTO-14 | Agente | OK | El ticket TKT-100780 bloquea cierre y reapertura manual desde la vista operativa interna. |  | Validacion automatizada exitosa |
...
| QA-AUTO-16 | Cliente | OK | El cliente ve cierre en TKT-100783 y reapertura en TKT-100784. |  | Validacion automatizada exitosa |
| QA-AUTO-16A | Supervisor | OK | El supervisor ve cierre en TKT-100785 y reapertura en TKT-100786. |  | Validacion automatizada exitosa |
| QA-AUTO-16B | Agente | OK | El agente ve cierre en TKT-100787 y reapertura en TKT-100788. |  | Validacion automatizada exitosa |
| QA-AUTO-17 | Cliente | OK | El ticket TKT-100789 persiste adjunto y lo muestra en detalle para cliente y agente. |  | Validacion automatizada exitosa |
| QA-AUTO-18 | Cliente | OK | El comentario publico sobre TKT-100790 persiste adjunto y es visible para agente y cliente. |  | Validacion automatizada exitosa |
| QA-AUTO-19 | Cliente | OK | La app bloquea adjuntos mayores a 5 MB con error controlado. |  | Validacion automatizada exitosa |
| QA-AUTO-20 | Cliente | OK | El cliente recibe notificaciones internas por comentario publico y resolucion sobre TKT-100791. |  | Validacion automatizada exitosa |
| QA-AUTO-21 | Agente | OK | El agente destino recibe notificacion interna al reasignar TKT-100792. |  | Validacion automatizada exitosa |
...
| QA-AUTO-23 | Agente | OK | El ticket TKT-100793 se comporta como estado final cerrado en cliente, agente y supervisor. |  | Validacion automatizada exitosa |
| QA-AUTO-24 | Sistema | OK | El ticket TKT-100794 se autocerro por vencimiento con motivo sin_respuesta_cliente y notificaciones emitidas. |  | Validacion automatizada exitosa |
| QA-AUTO-33 | Sistema | OK | El autocierre registro corrida success (y9g5eyeizv503y8) y libero el lock correctamente. |  | Validacion automatizada exitosa |
| QA-AUTO-34 | Sistema | OK | La segunda corrida quedo en skipped (0o0r658ngdgmzk0) al detectar lock activo. |  | Validacion automatizada exitosa |
| QA-AUTO-35 | Sistema | OK | El dry-run registro corrida pnv21brymiw9dfh sin modificar el ticket TKT-100796. |  | Validacion automatizada exitosa |
| QA-AUTO-36 | Sistema | OK | La corrida yveyzh6od2z7grp quedo en partial_failure, mantuvo TKT-100797 en resolved y cerro TKT-100798. |  | Validacion automatizada exitosa |
...
| QA-AUTO-08 | Agente | OK | Cliente confirmo cierre de TKT-100799 con closed_at persistido. |  | Validacion automatizada exitosa |
| QA-AUTO-09 | Supervisor | OK | Cliente solicito reapertura de TKT-100800 con motivo persistido. |  | Validacion automatizada exitosa |
...
- Fecha de cierre: 2026-04-11T10:15:04.783Z
