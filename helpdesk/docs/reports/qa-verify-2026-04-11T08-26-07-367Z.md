...
- Fecha: 2026-04-11T08:26:07.367Z
- Entorno: Local
- Version o referencia del build: QA_APP_URL=http://127.0.0.1:3045
...
- Estado final: FALLO
- Resumen ejecutivo: 33 casos OK, 1 casos con fallo.
...
| QA-AUTO-05 | Cliente | OK | Ticket TKT-100389 creado y visible en cliente/agente. |  | Validacion automatizada exitosa |
...
| QA-AUTO-07 | Supervisor | OK | Departamento QA Dept 1775895944729 creado, editado y visible en supervisor. |  | Validacion automatizada exitosa |
...
| QA-AUTO-13 | Agente | OK | El ticket TKT-100390 exige nota de resolucion y persiste resolution_note al resolver. |  | Validacion automatizada exitosa |
| QA-AUTO-14 | Agente | OK | El ticket TKT-100391 bloquea cierre y reapertura manual desde la vista operativa interna. |  | Validacion automatizada exitosa |
...
| QA-AUTO-16 | Cliente | OK | El cliente ve cierre en TKT-100394 y reapertura en TKT-100395. |  | Validacion automatizada exitosa |
| QA-AUTO-16A | Supervisor | OK | El supervisor ve cierre en TKT-100396 y reapertura en TKT-100397. |  | Validacion automatizada exitosa |
| QA-AUTO-16B | Agente | OK | El agente ve cierre en TKT-100398 y reapertura en TKT-100399. |  | Validacion automatizada exitosa |
| QA-AUTO-17 | Cliente | OK | El ticket TKT-100400 persiste adjunto y lo muestra en detalle para cliente y agente. |  | Validacion automatizada exitosa |
| QA-AUTO-18 | Cliente | OK | El comentario publico sobre TKT-100401 persiste adjunto y es visible para agente y cliente. |  | Validacion automatizada exitosa |
| QA-AUTO-19 | Cliente | OK | La app bloquea adjuntos mayores a 5 MB con error controlado. |  | Validacion automatizada exitosa |
| QA-AUTO-20 | Cliente | OK | El cliente recibe notificaciones internas por comentario publico y resolucion sobre TKT-100402. |  | Validacion automatizada exitosa |
| QA-AUTO-21 | Agente | OK | El agente destino recibe notificacion interna al reasignar TKT-100403. |  | Validacion automatizada exitosa |
...
| QA-AUTO-23 | Agente | OK | El ticket TKT-100404 se comporta como estado final cerrado en cliente, agente y supervisor. |  | Validacion automatizada exitosa |
| QA-AUTO-24 | Sistema | OK | El ticket TKT-100405 se autocerro por vencimiento con motivo sin_respuesta_cliente y notificaciones emitidas. |  | Validacion automatizada exitosa |
| QA-AUTO-25 | Supervisor | FALLO | La exportacion CSV no devolvio nombre de archivo esperado. | La exportacion CSV no devolvio nombre de archivo esperado. | Revisar evidencia e incidencia |
...
| QA-AUTO-08 | Agente | OK | Cliente confirmo cierre de TKT-100406 con closed_at persistido. |  | Validacion automatizada exitosa |
| QA-AUTO-09 | Supervisor | OK | Cliente solicito reapertura de TKT-100407 con motivo persistido. |  | Validacion automatizada exitosa |

## Incidencias abiertas

| ID incidencia | Severidad | Caso asociado | Descripcion | Estado |
| --- | --- | --- | --- | --- |
| INC-AUTO-001 | Alta | QA-AUTO-25 | La exportacion CSV no devolvio nombre de archivo esperado. | Abierta |
...
- Fecha de cierre: 2026-04-11T08:26:07.367Z
